    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .display:
            guard !viewModel.media.isEmpty else {
                let cell: SkeletonDisplayTableViewCell = SkeletonDisplayTableViewCell.create(in: tableView, for: indexPath, with: viewModel)
                return cell
            }
            
            displayCell = DisplayTableViewCell.create(in: tableView, for: indexPath, with: viewModel)
            return displayCell
            
        case .rated:
            let cell: MediaHybridCell<RatingCollectionViewCell> = MediaHybridCell<RatingCollectionViewCell>.create(in: tableView, for: indexPath, with: viewModel)
            
            return cell
            
        case .resumable:
            
            let cell: MediaHybridCell<ResumingCollectionViewCell> = MediaHybridCell<ResumingCollectionViewCell>.create(in: tableView, for: indexPath, with: viewModel)
            
            return cell
            
        case .blockbuster:
            
            let cell: MediaHybridCell<BrandCollectionViewCell> = MediaHybridCell<BrandCollectionViewCell>.create(in: tableView, for: indexPath, with: viewModel)
            
            return cell
            
        default:
            
            let cell: MediaHybridCell<PosterCollectionViewCell> = MediaHybridCell<PosterCollectionViewCell>.create(in: tableView, for: indexPath, with: viewModel)
...
/*
 ...
 final class MediaTableViewDataSource: NSObject,
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
         ...
         case .rated:
             return MediaHybridCell<RatingCollectionViewCell>.create(in: tableView, for: indexPath, with: viewModel)
             
         case .resumable:
             return MediaHybridCell<ResumingCollectionViewCell>.create(in: tableView, for: indexPath, with: viewModel)
             
         case .blockbuster:
             return MediaHybridCell<BrandCollectionViewCell>.create(in: tableView, for: indexPath, with: viewModel)
             
         default:
             return MediaHybridCell<PosterCollectionViewCell>.create(in: tableView, for: indexPath, with: viewModel)
         }
     }
